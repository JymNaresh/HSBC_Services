...
namespace PGPSnippet.PGPDecryption
{
    public class PGPDecrypt
    {
        ...
        public static void EncryptAndSign(string inputFile, string outputFile)
        {
            ...
            EncryptAndSign(inputFile, outputFile, PublicKeyPath,PrivateKeyOnlyPath, Password, true);
        }
        ...
        private static Stream ChainEncryptedOut(Stream outputStream, PgpEncryptionKeys m_encryptionKeys)
        {
            ...
            encryptedDataGenerator = new PgpEncryptedDataGenerator(SymmetricKeyAlgorithmTag.Aes256, new SecureRandom());
       ...
       */
        ...
        public static void Decrypt(string inputfile, string outputFile)
        {
            ...
            if (!File.Exists(PrivateKeyOnlyPath))
                throw new FileNotFoundException(String.Format("Private Key File [{0}] not found.", PrivateKeyOnlyPath));
            ...
            using (Stream inputStream = File.OpenRead(inputfile))
            {
                ...
                {
                    Decrypt(inputStream, keyIn, Password, outputFile);
                }
            }
        }
